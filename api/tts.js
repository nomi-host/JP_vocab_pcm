...
// --- 보안 설정 -------------------------------------------------------------
// 허용 출처. 배포처 확정 시 ALLOWED_EXACT에 정식 도메인 추가.
// (현재 *.vercel.app / localhost / github.io / Origin 없는 동일배포 요청 허용)
const ALLOWED_EXACT = ["https://nomi-host.github.io"];
...
const RATE_MAX = 300;         // IP당 60초에 최대 호출 수 (백그라운드 굽기가 30단어×세그먼트를 짧은 시간에 호출)
